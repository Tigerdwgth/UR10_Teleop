...
pA=[-550,-586,551,-154,3,135]
pB=[-99,-254,201,-171,2,175]
pC=[265,-369,237,-178,1,-139]
...
class DobotDemo:
    ...
    def RunPoint(self, point_list):
        ...
        currentCommandID = self.parseResultId(recvmovemess)[0]
        print("指令 ID:", currentCommandID)
        #sleep(0.02)
        while True:  #完成判断循环

            print(self.feedData.robotMode)
            print("robocurCMDid",self.feedData.robotCurrentCommandID,"curCMD",currentCommandID)
...
recvmovemess = dd.dashboard.MovJ(*pA, 0)
sleep(1)
dd.dashboard.Stop()
recvmovemess = dd.dashboard.MovJ(*pC, 0)
